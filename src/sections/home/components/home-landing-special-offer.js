...
import ProductColorPicker from "./subcomponents/product-color-picker";
import ProductOptionPicker from "./subcomponents/product-option-picker";
...
export default function HomeLandingSpecialOffer() {
