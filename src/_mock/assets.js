...
export const _fullAddress = [
  `Баянгол дүүрэг, Дилавхутагт
Жамсранжавын гудамж, 19 дүгээр хороо, Оймон
оффис, Ulaanbaatar, Mongolia, 16070`,
...
export const _fullNames = [
  ...
  "Сургалтын менежер",
  "Агуулахын эрхлэгч",
  "Эмнэлгийн тоног төхөөрөмжийн инженер-2",
  "Борлуулалтын ажилтан-3 ",
  "Үйлчилгээ,түгээлтийн ажилтан-4",
];
...
ажилласан.`,
  ...
  "Эм зүйч",
  `Эмнэлэгийн тоног
төхөөрөмжийн инженер,
Мэдээллийн технологийн
инженер`,
  `Шүдний техникч
Сувилагч
Шүдний эмнэлэгийн туслах`,
];
